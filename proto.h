...
SourceFormatType currentSourceFormat;
char currentTime[9];
SourceFormatType defaultSourceFormat;
Name *duplicateds;
u32 errorCount;
u64 errorUnion;
Module *firstModule;
